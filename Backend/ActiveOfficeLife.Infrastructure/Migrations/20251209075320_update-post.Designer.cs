...
namespace ActiveOfficeLife.Infrastructure.Migrations
{
    ...
    [Migration("20251209075320_update-post")]
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("23923a1c-16bf-479f-8405-343eadc00ba8"),
                            Description = "Quản trị viên hệ thống",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("851c0aed-16f4-4c48-ba7d-def14e1c9a23"),
                            Description = "Người dùng bình thường",
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("2a72bdc5-321a-457e-abf8-3efa93e0986c"),
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0cf2e7a0-62c0-4ab8-899a-e2032cb0c667"),
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bbfed0d7-9ba8-4bdd-9ea7-1b771c37e426"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeofficelife@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAECCMS+99pMUlnrTGk5TZ0UQQ1ZB88wJmONmowMl3jpT8tmq2C/QY2SYGmRa2L2Plsw==",
                            Status = "Active",
                        ...
                        new
                        {
                            Id = new Guid("4255d354-3ebe-4a8c-adbf-d6f254a6397f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeoffice@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAENcKJqhWm5lDxNbY+fEtbUS+L8eJEhSbKpjQTOi8gGC4UbLTJL7UvwGH96TOX3yZcA==",
                            Status = "Active",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Username = "user"
                        });
            ...
            modelBuilder.Entity("UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("bbfed0d7-9ba8-4bdd-9ea7-1b771c37e426"),
                            RoleId = new Guid("23923a1c-16bf-479f-8405-343eadc00ba8")
                        },
                        new
                        {
                            UserId = new Guid("bbfed0d7-9ba8-4bdd-9ea7-1b771c37e426"),
                            RoleId = new Guid("851c0aed-16f4-4c48-ba7d-def14e1c9a23")
                        },
                        new
                        {
                            UserId = new Guid("4255d354-3ebe-4a8c-adbf-d6f254a6397f"),
                            RoleId = new Guid("851c0aed-16f4-4c48-ba7d-def14e1c9a23")
                        });
                });

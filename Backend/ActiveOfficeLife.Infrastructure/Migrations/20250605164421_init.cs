        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_SeoMetaData_SeoMetadataId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tags_SeoMetaData_SeoMetadataId",
                        column: x => x.SeoMetadataId,
                        principalTable: "SeoMetaData",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medias_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_SeoMetadataId",
                table: "Categories",
                column: "SeoMetadataId",
                unique: true,
                filter: "[SeoMetadataId] IS NOT NULL");

...
namespace ActiveOfficeLife.Infrastructure.Migrations
{
    ...
    [Migration("20251203074958_update-identity-categorytypeid")]
    partial class updateidentitycategorytypeid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3d427b5b-6028-4bc5-a8fc-a1a2d9c9e9e8"),
                            Description = "Quản trị viên hệ thống",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("e20b6cf3-7622-447f-8db9-ed1d22dbcaf7"),
                            Description = "Người dùng bình thường",
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("5458b0da-528c-4de7-bae3-87556b9a1351"),
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c26b7dd4-c757-48d0-9e27-92b03d81df54"),
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("45167155-b25e-4b95-af4c-731df5cd9ece"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeofficelife@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAENjywaBhydzSMk6LFClhFRHjq7oOLjj1bSvhOXD8/g/uPoSpjlNRgRkBg9ltPhYU+w==",
                            Status = "Active",
                        ...
                        new
                        {
                            Id = new Guid("3fec30bd-e424-49ea-a764-3ccc1c4c2202"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeoffice@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEPSug/qdTc9pUQOldjCt5MuiiXG7OEn+Y3eksjQRkvP0xNyEcqAD23vpEW0ysh4rXw==",
                            Status = "Active",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Username = "user"
                        });
            ...
            modelBuilder.Entity("UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("45167155-b25e-4b95-af4c-731df5cd9ece"),
                            RoleId = new Guid("3d427b5b-6028-4bc5-a8fc-a1a2d9c9e9e8")
                        },
                        new
                        {
                            UserId = new Guid("45167155-b25e-4b95-af4c-731df5cd9ece"),
                            RoleId = new Guid("e20b6cf3-7622-447f-8db9-ed1d22dbcaf7")
                        },
                        new
                        {
                            UserId = new Guid("3fec30bd-e424-49ea-a764-3ccc1c4c2202"),
                            RoleId = new Guid("e20b6cf3-7622-447f-8db9-ed1d22dbcaf7")
                        });
                });

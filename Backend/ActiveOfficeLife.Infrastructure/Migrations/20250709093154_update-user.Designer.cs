...
namespace ActiveOfficeLife.Infrastructure.Migrations
{
    ...
    [Migration("20250709093154_update-user")]
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0daa0446-8569-46fa-9aed-671c7558248e"),
                            Description = "Quản trị viên hệ thống",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("2d51b941-5c52-424c-9d5a-e70a1a6872d5"),
                            Description = "Người dùng bình thường",
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("40291fb7-65c7-451b-af7d-4f17b71b785e"),
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e1f3376-2db7-4645-b112-d0f833037c73"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeofficelife@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEBZRG45lwmAOdkQHtIJYc5d4nzHK52jbtuvCZoQ9vJxWNCdpcYVfhzj3ZTv29srtGw==",
                            Status = "Active",
                        ...
                        new
                        {
                            Id = new Guid("68b1856d-9e4d-4749-b4f6-c992ef07e28f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeoffice@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEHOEub9gaR8VFFAWXtf7hLxa2RWCdRn4Rg7lOQYx2xKHUSbmuu48Bl5Pk5f6j4FgXQ==",
                            Status = "Active",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Username = "user"
                        });
            ...
            modelBuilder.Entity("ActiveOfficeLife.Infrastructure.EFCore.Configurations.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8de5e0a0-b183-4c5c-94f5-b2b1ac572969"),
            ...
            modelBuilder.Entity("UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("2e1f3376-2db7-4645-b112-d0f833037c73"),
                            RoleId = new Guid("0daa0446-8569-46fa-9aed-671c7558248e")
                        },
                        new
                        {
                            UserId = new Guid("2e1f3376-2db7-4645-b112-d0f833037c73"),
                            RoleId = new Guid("2d51b941-5c52-424c-9d5a-e70a1a6872d5")
                        },
                        new
                        {
                            UserId = new Guid("68b1856d-9e4d-4749-b4f6-c992ef07e28f"),
                            RoleId = new Guid("2d51b941-5c52-424c-9d5a-e70a1a6872d5")
                        });
                });

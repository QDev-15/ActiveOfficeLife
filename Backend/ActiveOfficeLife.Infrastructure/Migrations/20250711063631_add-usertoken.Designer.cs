...
namespace ActiveOfficeLife.Infrastructure.Migrations
{
    ...
    [Migration("20250711063631_add-usertoken")]
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("089383b1-65dc-401b-b671-88ec3f08086c"),
                            Description = "Quản trị viên hệ thống",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("6cf393c7-7857-404b-8d4e-b128903abafb"),
                            Description = "Người dùng bình thường",
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("6d6ecd29-6ace-4ed2-8a38-97fa22221924"),
            ...
            modelBuilder.Entity("ActiveOfficeLife.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d871d90-e875-4162-94ab-9dfa0d4686dd"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeofficelife@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEKUK2wZQg20z1C0qJSHIx5qfpH6DepPWIGopJF83Wny627Pju1+PFQckDGa+j1CI3A==",
                            Status = "Active",
                        ...
                        new
                        {
                            Id = new Guid("2659ca4a-b0ae-490c-9b09-fe8bcad44a1f"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "activeoffice@gmail.com",
                            PasswordHash = "AQAAAAIAAYagAAAAEEsfUd/AKIGqz4rFPbzRHl6RAexwcV76U1avBgv4KjODBctPqY4a+RXrD04RBVqIlA==",
                            Status = "Active",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Username = "user"
                        });
            ...
            modelBuilder.Entity("ActiveOfficeLife.Infrastructure.EFCore.Configurations.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9d528a17-ade9-4c4f-8556-c67fce80c61e"),
            ...
            modelBuilder.Entity("UserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5d871d90-e875-4162-94ab-9dfa0d4686dd"),
                            RoleId = new Guid("089383b1-65dc-401b-b671-88ec3f08086c")
                        },
                        new
                        {
                            UserId = new Guid("5d871d90-e875-4162-94ab-9dfa0d4686dd"),
                            RoleId = new Guid("6cf393c7-7857-404b-8d4e-b128903abafb")
                        },
                        new
                        {
                            UserId = new Guid("2659ca4a-b0ae-490c-9b09-fe8bcad44a1f"),
                            RoleId = new Guid("6cf393c7-7857-404b-8d4e-b128903abafb")
                        });
                });
